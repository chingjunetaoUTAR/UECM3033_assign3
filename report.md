...
![Graph of y0 and y1 against t with y0(0)=01.png](Graph of y0 and y1 against t with y0(0)=0.1.png) 
...
![Graph of y1 against y0 with y0(0) = 01.png](Graph of y1 against y0 with y0(0) = 0.1.png) 
...
![Graph of y0 and y1 against t with y0(0)=011.png](Graph of y0 and y1 against t with y0(0)=0.11.png) 

![Graph of y1 against y0 with y0(0) = 011.png](Graph of y1 against y0 with y0(0) = 0.11.png) 
